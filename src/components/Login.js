...
export default function Login() {
  ...
  return (
    ...
    <div className="flex shadow-md max-w-screen-xl">
      ...
      <div className="flex flex-wrap content-center justify-center rounded-l-md bg-white sm:w-full md:w-2/3 lg:w-1/2 xl:w-2/5 md:h-96 lg:h-auto xl:h-auto">
      ...
      <div className="hidden sm:block sm:w-1/3 md:w-1/2 lg:w-1/2 xl:w-3/5">
        <img
          ...
          src="https://bepro.cl/cdn/shop/files/183602023_1_5000x.png?v=1699462663"
          alt="Login Banner"
        />
      </div>
    </div>
